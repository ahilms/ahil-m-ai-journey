...
export const ContactSection = () => {
  ...
  return (
    <section id="contact" className="py-20 md:py-32 bg-secondary/30 relative" ref={ref}>
            ...
            <div className="glass-card p-6">
              ...
              <div className="flex gap-4">
                <a
                  ...
                  className="w-12 h-12 rounded-lg bg-secondary flex items-center justify-center hover:bg-primary/10 transition-colors group"
                >
